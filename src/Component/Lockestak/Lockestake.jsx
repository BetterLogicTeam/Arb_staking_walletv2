            ...
            <div className="container-fluid p-0  mt-5">
              <div className="row justify-content-center">
                <div className="col-lg-5 all_main p-0">
                  <h3 class="staking__selector__heading">Stake ARB TOKEN</h3>

                  <div className="first_box mt-4  px-2">
                    <div className="munt_box d-flex justify-content-between">
                      <span className="">Amount [Min: 1 ARB]</span>
                  ...
                  <div className="last mt-4">
                    <p className="fon m-0 py-2">
                      Locking {getValue} ARB TOKEN for {selectDays} Days, You
            ...
            <div className="container-fluid p-0  mt-5">
              <div className="row justify-content-center">
                <div className="col-lg-5 all_main p-0">
                  ...
                  <div className="last mt-4">
                    <p className="fon m-0 py-2">
                      Locking {getValue} ARB TOKEN for {selectDays} Days
                    </p>
                  </div>
                </div>
              </div>

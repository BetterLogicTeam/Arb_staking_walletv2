...
import "./Updated.css"
import size from "../Accets/side1.png"
...
export default function Updated() {
  return (
    ...
    <h3 className='htu text-center text-white'>HOW TO USE STAKING ARB TOKEN</h3>

    
    <p className='htu_p'>Before following the steps to stake your ARB token, you will need to fund your wallet with ARB token. Get your ARB Token from Any Exchange and then follow the steps on this app to stake your ARB token to Earn ARB coin.</p>
...
<div className="container py-5">
    <div className="row justify-content-center align-items-center">
        ...
        <div className="col-md-6">
            ...
            <h5> Input the amount of ARB (Min:1 ARB) to stake  </h5>
